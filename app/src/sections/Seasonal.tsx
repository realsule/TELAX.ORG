...
import { seasonalConfig } from '../config';
    ...
    >
      ...
      >
        <p className="font-mono text-xs uppercase tracking-[0.2em] text-muted-telax mb-8">
          {seasonalConfig.sectionLabel}
        </p>

        <h2 className="font-display text-[clamp(40px,5vw,80px)] font-black text-chalk leading-[0.85] mb-8">
          <span className="block">{seasonalConfig.headlineLine1}</span>
          <span className="block text-forest">{seasonalConfig.headlineLine2}</span>
        </h2>
        ...
        <a
          href={seasonalConfig.ctaHref}
          className="btn-secondary inline-flex items-center gap-2 group"
        >
          {seasonalConfig.ctaText}
