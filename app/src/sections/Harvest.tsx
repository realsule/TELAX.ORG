  ...
  return (
    ...
    >
      ...
      <div ref={bgRef} className="absolute inset-0" style={{ opacity: 1, transform: 'scale(1)' }}>
        <img
          src={harvestConfig.backgroundImage}
          alt="Harvest"
      ...
      <div ref={titleRef} className="absolute left-[6vw] top-[18vh]" style={{ opacity: 1, transform: 'translateY(0)' }}>
        <h2 className="font-display text-[clamp(48px,9vw,160px)] font-black text-chalk leading-[0.85] tracking-tight">
          <span className="title-line block">{harvestConfig.headlineLine1}</span>
          <span className="title-line block text-forest">{harvestConfig.headlineLine2}</span>
        </h2>
      </div>
      ...
      >
        <p className="text-lg text-chalk/90 leading-relaxed mb-6">
          {harvestConfig.description}
        </p>
        <a
          href={harvestConfig.ctaHref}
